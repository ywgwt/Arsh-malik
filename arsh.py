...
def pkgs():
        love("\033[1;91m«-----------------\033[1;96mMoynul hassan\033[1;91m-----------------»")
        ...
        love("\033[1;91m«------------------Moynul hassan----------------»")
        love("\033[1;95mmoynul457 2nd Tool Start ComingSoon New Update»")
        love("\033[1;96m «-----------------\033[1;92mMoynul hassan\033[1;96m--------------»")
        time.sleep(0.3)
...
def menu():
    ...
    print(logo)
    os.system('clear')
    os.system('echo  MoYnUL░░░░░░HaSsAn░░Bangladesh ░ETICAL░░HACKER | lolcat -a -F 0.1')
    os.system('echo  Moynul░░░░░Hassan██WEB██DEVELOPER░██ | lolcat -a -F 0.1')
    os.system('echo  WHATSAPP░░░░░+8801892260962░░FOR THIS SCRIPT░ | lolcat -a -F 0.1')
    os.system('echo  CONTACT  ░░░░░ME ON Facebook░░Moynul CYBER HACKER░ | lolcat -a -F 0.1')
    ...
    os.system('echo  HI, I AM Moynul hassan A ETICAL HACKER | lolcat -a -F 0.1')
    os.system('echo  WE ARE ANONYMOUS WE ARE LEGION WE NEVER FORGIVE WE NEVER FORGET ASPECT US | lolcat -a -F 0.1')
    os.system('echo  SHABIR BALOCH WHATSAPP = +8801892260962 | lolcat -a -F 0.1')
    os.system('echo  VISIT OUR YOUTUBE CHANNEL YT gaming FFH | lolcat -a -F 0.1')
    os.system('echo  Bangladesh  ETICAL HACKER AND A PROGRAMMER | lolcat -a -F 0.1')
    os.system('echo  LETS░░░░░ENJOY░░OUR░░░░░TOOL░░THCB | lolcat -a -F 0.1')
    os.system('echo  ------ Your Mind is Your Best Weapon------&&date  | lolcat -a -F 0.1')
    os.system('echo ----------------SHABIR BALOCH-----------------| lolcat')
    os.system('echo  ┈┈┈◢▇◣◢▇◣┈┈◢▇◣◢▇◣┈┈◢▇◣◢▇◣┈┈┈┈  Moynul hassan| lolcat --animate')
    os.system('echo  ┈┈┈▇▇▇▇▇▇┈┈▇▇▇▇▇▇┈┈▇▇▇▇▇▇┈┈┈┈  Moynu457| lolcat --animate')
    os.system('echo  ┈┈┈◥▇▇▇▇◤┈┈◥▇▇▇▇◤┈┈◥▇▇▇▇◤┈┈┈┈| lolcat')
    os.system('echo  ┈┈┈┈◥▇▇◤┈┈┈┈◥▇▇◤┈┈┈┈◥▇▇◤┈┈┈┈┈   WhatsApp| lolcat --animate')
    os.system('echo  ┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈◥◤┈┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈◥◤┈┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈◥◤┈┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈┈+8801892260962| lolcat --animate')
    os.system('echo -----------------Termux help center BD----------------| lolcat --animate')
    ...
    os.system('echo -----------------Arsh malik----------------| lolcat --animate')
    time.sleep(0.0005)
    ...
    time.sleep(0.0005)
    os.system('echo [L]  Install Moynul457 Clonnig----------------- Tool ----● | lolcat --animate')
    time.sleep(0.0005)
    ...
    time.sleep(0.0005)
    os.system('echo [W]  moynul Facebook  Group-------- Tool----● | lolcat --animate')
    time.sleep(0.0005)
    os.system('echo [X]  THCB Dragon404 New Update -----● | lolcat -a -F 0.01')
    time.sleep(0.0005)
...
def mafia():
        ...
        if black =="":
                ...
                print (logo)
                love("\033[1;93mTool User Name :\033[1;95m     Arsh
                love("\033[1;93mTool Password  :\033[1;95m     malik
                time.sleep(5)
                ...
                print (logo)
                love("\033[1;93mTool User Name :\033[1;95m     THCB ")
                love("\033[1;93mTool Password  :\033[1;95m     457 ")
                ...
                clear()
                print(logo)
                love("Welcome To Moynul 457 2nd Tool")
